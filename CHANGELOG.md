...
NEW FEATURES:
- Add `dnsdist_service_masked`, matching the `pdns` and `pdns_recursor` roles. Masking is a systemd concept and is ignored on hosts without systemd ([\#198](https://github.com/PowerDNS/dnsdist-ansible/pull/198))
